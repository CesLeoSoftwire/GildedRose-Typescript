...
describe('Backstage passes to a TAFKAL80ETC concert', function () {
    ...
    describe("Over 10 sellIn", function () {
        it('when 1 day passes quality increases by 1', function () {
        ...
        it('when 2 days pass quality increases by 2', function () {
            const gildedRose = new GildedRose([
                new Item('Backstage passes to a TAFKAL80ETC concert', 17, 20),
                new Item('Backstage passes to a TAFKAL80ETC concert', 13, 50)]);
        ...
        it('when 3 days pass quality increases by 3', function () {
            const gildedRose = new GildedRose([
                new Item('Backstage passes to a TAFKAL80ETC concert', 17, 20),
                new Item('Backstage passes to a TAFKAL80ETC concert', 13, 50)]);
    ...
    describe("Between 6 and 10 sellIn", function () {
        it('when 1 day passes quality increases by 2', function () {
            const gildedRose = new GildedRose([
        ...
        it('when 2 days pass quality increases by 4', function () {
            const gildedRose = new GildedRose([
                new Item('Backstage passes to a TAFKAL80ETC concert', 10, 20),
                new Item('Backstage passes to a TAFKAL80ETC concert', 6, 50)]);
        ...
        it('when 3 days pass quality increases by 6', function () {
            const gildedRose = new GildedRose([
                new Item('Backstage passes to a TAFKAL80ETC concert', 10, 20),
                new Item('Backstage passes to a TAFKAL80ETC concert', 13, 50)]);
    ...
    describe("Between 0 and 5 sellIn", function () {
        it('when 1 day passes quality increases by 3', function () {
            const gildedRose = new GildedRose([
        ...
        it('when 2 days pass quality increases by 6', function () {
            const gildedRose = new GildedRose([
        ...
        it('when 3 days pass quality increases by 9', function () {
            const gildedRose = new GildedRose([
